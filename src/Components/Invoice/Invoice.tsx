...
const Invoice = () => {
  ...
  const { 
    register, // for register field name in form 
    handleSubmit, // for submit form data
    control, // for control field name (onChange, value change)
    watch, // for use changed value show 
    formState: { errors } // for formState have errors message to check error
   } = useForm({
    shouldUseNativeValidation: true, // validation 
  });
  const { fields, append, remove } = useFieldArray({
    name: "invoiceItem",
    control,
  });
  const values = watch(); // check changed values 
                ...
                <Box className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  ...
                  >
                    ...
                    <TextField
                      ...
                      {...register("billToUserName", { required: 'Please Fill The Billing To Name' })}
                      error={!!errors['billToUserName']}
                    />
                    <TextField
                      type="email"
                      label="Email Address"
                      {...register("billToUserEmail", { required: 'Please Fill The Billing To Email' })}
                    />
                    <TextField
                      type="text"
                      label="Bill Address"
                      {...register("billToUserBillingAddress", { required: 'Please Fill The Billing To Address' })}
                      error={!!errors['billToUserBillingAddress']}
                    />
                  </Box>
                </Box>
                ...
                <Box className="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                  ...
                  >
                    ...
                    <TextField
                      ...
                      {...register("billFromUserName", { required: 'Please Fill The Billing From Name' })}
                      error={!!errors['billFromUserName']}
                    />
                    <TextField
                      type="email"
                      label="Email Address"
                      {...register("billFromUserEmail", { required: 'Please Fill The Billing From Email' })}
                      error={!!errors['billFromUserEmail']}
                    />
                    <TextField
                      type="text"
                      label="Bill Address"
                      {...register("billFromUserBillingAddress", { required: 'Please Fill The Billing From Address' })}
                      error={!!errors['billFromUserBillingAddress']}
                      />
                  </Box>
                </Box>
              </Box>
